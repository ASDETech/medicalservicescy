      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12">
          ...
          <div class="space-y-8">
              ...
              <div class="space-y-6">
                <div class="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Available 24/7 for emergencies</p>
                  </div>
                </div>
            ...
            <div class="bg-gradient-to-br from-primary-500 to-primary-500 rounded-2xl p-8 text-white">
              <h3 class="text-2xl font-bold mb-4">Need Immediate Assistance?</h3>
              <p class="text-white/90 mb-6">
                For medical emergencies, don't wait. Call our emergency hotline now for immediate response.
              </p>
              <a
                href="tel:+35799123456"
                class="inline-flex items-center justify-center gap-2 bg-white text-primary-500 px-8 py-4 rounded-full hover:bg-gray-100 transition-all font-bold shadow-xl w-full"
              >
                <span>📞</span>
                Emergency Call
              </a>
